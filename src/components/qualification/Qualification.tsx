            ...
            <div className={`${styles.qualification__container} container`}>
                <div className={`${styles.qualification__tabs}`}>
                    <div onClick={() => toggleTab(1)}
                         className={toggleState === 1 ? `${styles.qualification__button} ${styles.qualification__active} button__flex` : `${styles.qualification__button} button__flex`}>
                        <i className={`${styles.qualification__icon} uil uil-graduation-cap`}></i> 经验
                    </div>

                    <div onClick={() => toggleTab(2)}
                         className={toggleState === 2 ? `${styles.qualification__button} ${styles.qualification__active} button__flex` : `${styles.qualification__button} button__flex`}>
                        <i className={`${styles.qualification__icon} uil uil-briefcase-alt`}></i> 教育
                    </div>
                </div>
                ...
                <div className={`${styles.qualification__sections}`}>
                    <div
                        className={toggleState === 1 ? `${styles.qualification__content} ${styles.qualification__content__active}` : `${styles.qualification__content}`}>
                    ...
                    <div
                        className={toggleState === 2 ? `${styles.qualification__content} ${styles.qualification__content__active}` : `${styles.qualification__content}`}>
                        <div className={`${styles.qualification__data}`}>
                            <div>
