      ...
      <div className={`${styles.services__container} container grid`}>
        <div className={styles.services__content}>
          <div className={styles.services__block}>
            <i className={`uil uil-web-grid ${styles.services__icon}`}></i>
          ...
          >
            进一步了解{" "}
            <i
              className={`uil uil-arrow-right ${styles.services__button__icon}`}
            ></i>
          </span>
          ...
          <div
            className={
              toggleState === 1
                ? `${styles.services__modal} ${styles.active__modal}`
                : styles.services__modal
            }
          >
            <div className={styles.services__modal__content}>
              <i
                className={`uil uil-times ${styles.services__modal__close}`}
                onClick={() => toggleTab(0)}
              ></i>
              <h3 className={styles.services__modal__title}>产品设计师</h3>
              <p className={styles.services__modal__description}>
              ...
              <ul className={`${styles.services__modal__services} grid`}>
                <li className={`${styles.services__modal__service}`}>
                  <i
                    className={`${styles.services__modal__icon} uil uil-check-circle`}
                  ></i>
                  <p className={`${styles.services__modal__info}`}>
        ...
        <div className={styles.services__content}>
          <div className={styles.services__block}>
            <i className={`uil uil-arrow ${styles.services__icon}`}></i>
            <h3 className={styles.services__title}>
              UI/UX <br /> 设计师
            </h3>
          </div>
        ...
        <div className={styles.services__content}>
          <div className={styles.services__block}>
            <i className={`uil uil-edit ${styles.services__icon}`}></i>
            <h3 className={styles.services__title}>
              视觉 <br /> 设计师
            </h3>
          </div>
